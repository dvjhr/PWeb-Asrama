...
?>
    ...
    <!-- banner part start-->
    <section class="banner_part overlay-black">
        <div class="container">
                ...
                <div class="col-lg-10">
                    <div class="banner_text text-center">
                        <div class="banner_text_iner">
                            ...
                            <a href="cek.php" class="btn_1">Pesan Sekarang</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="booking_menu">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                            <p class="nav-link" id="hotel-tab" role="tab">Booking Sekarang</p>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-12">
                                ...
                                <div class="booking_form">
                                    <form action="#">
                                        <div class="form-row">
                                            ...
                                            <div class="form_colum">
                                                <h6>Gedung</h6>
                                                <select class="nc_select" placeholder="Pilih">
                                            ...
                                            <div class="form_btn">
                                                <a href="#" class="btn_1">Cek Ketersediaan</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                        <h2>Fasilitas</h2>
                        <p>Asrama ITS dilengkapi berbagai fasilitas bagi setiap penghuninya</p>
                    </div>
                </div>
            </div>
            <div class="row">
